...
function ButuGari() {
  ...
  this.manualAdressButton = document.getElementById('manualAdressButton')
  ...
  // Manual Adress handler
  this.manualAdressButton.addEventListener('click', this.manualAdress.bind(this))
...
// Saves a new Adress on the Firebase DB.
ButuGari.prototype.saveAdress = function(e) {
  e.preventDefault();
  // Check that the user entered an Adress and is signed in.
  if (this.AdressInput.value && this.checkSignedInWithAdress()) {
    ...
    this.AdressRef.push({
      ...
      ButuGari.resetMaterialTextfield(this.manualAdress);
      this.toggleButton();
